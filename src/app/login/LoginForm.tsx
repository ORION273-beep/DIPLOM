    ...
    <LoginSplitQuoteImage01
      ...
      footer={
        <p className="text-center text-sm text-tertiary">
          Нет аккаунта?{' '}
          <Link href={registerHref} className="font-medium text-brand-secondary hover:underline">
            Зарегистрироваться
          </Link>
        </p>
      }
        ...
        <div className="flex flex-col gap-5">
          ...
          <div>
            <div className="mb-1.5 flex items-center justify-between">
              ...
              <Link href="/forgot-password" className="text-sm font-medium text-brand-secondary hover:underline">
                Забыли пароль?
              </Link>
            </div>
            <Input
