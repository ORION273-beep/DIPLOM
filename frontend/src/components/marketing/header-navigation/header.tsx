...
const MobileFooter = () => {
    return (
        <div className="flex flex-col gap-3 border-t border-secondary px-4 py-6">
            ...
            <Button color="primary" size="md" href="/register">
                Регистрация
            </Button>
        </div>
    );
            ...
            <div className="flex size-full max-w-container flex-1 items-center pr-3 pl-4 md:px-8">
                ...
                >
                    <div className="flex min-w-0 flex-1 items-center gap-3 md:gap-5">
                        {logo ?? <OneSecLogo href="/" />}

                        {search && <div className="hidden max-w-xs flex-1 md:block lg:max-w-sm">{search}</div>}
                    ...
                    <div className="flex items-center gap-2 md:gap-3">
                        ...
                        {!hideAuthButtons && (
                            <div className="hidden items-center gap-3 md:flex">
                                <Button color="secondary" size={isFloating ? "md" : "sm"} href="/login">
                                    Войти
                                </Button>
                                <Button color="primary" size={isFloating ? "md" : "sm"} href="/register">
                                    Регистрация
                                </Button>
                            </div>
                        )}
                            ...
                            >
                                <AriaDialog className="outline-hidden">
                                    <nav className="w-full bg-primary shadow-lg">
                                        {mobileExtra && <div className="border-b border-secondary px-4 py-4">{mobileExtra}</div>}
